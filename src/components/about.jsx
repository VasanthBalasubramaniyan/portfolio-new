                ...
                <div>
                    ...
                    >
                        ...
                        <p className="about-section__desc mt-6 text-2xl text-justify md:text-xl leading-relaxed">
                            I'm a passionate and detail-oriented Computer Science graduate with 2.7 years of experience as a Data Engineer and a strong foundation in web development. I bring a solid skill set in Python, PySpark, SQL, data warehousing, and data modeling, along with hands-on experience using AWS services. I'm also proficient in ReactJS and version control with GitHub, and have deployed full-stack applications using platforms like Render. 
                            <br/><br/>
                            As a <span className="font-bold text-[#7A51EB]">vibe coder</span>, I thrive on creative problem-solving and intuitive development approaches. I'm well-versed in <span className="font-bold text-[#7A51EB]">AI technologies</span> and leverage modern AI tools to enhance my development workflow and create innovative solutions. I enjoy building responsive, user-friendly interfaces and writing clean, maintainable code. I'm eager to contribute to real-world projects and continuously grow as a developer and data professional.
                        </p>
                    </div>
                </div>
            </div>
