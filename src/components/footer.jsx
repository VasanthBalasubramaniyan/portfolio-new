  ...
  return (
    <>
      <footer 
        ref={footerRef}
        id="contact" 
        className={`footer-container mt-20 bg-gradient-to-r from-[#7A51EB] to-[#9F7AEA] text-white fade-in-up ${isFooterVisible ? 'visible' : ''}`}
      >
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center gap-6">
              <a 
                ...
                className="bg-white/10 hover:bg-white/20 rounded-full p-4 transition-all duration-300 hover:scale-110 hover-lift"
